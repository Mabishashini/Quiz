    ...
    <div className='quiz-created'>
      ...
      <div className="quiz-created-container">
        <div className="quiz-created-innerContainer">
          ...
          <p className='quiz-created-gamepin'>Game PIN: {gamePin}    {copied && <span className="copied-text">Copied ✓</span>}       <p className="copy-button" onClick={handleCopyPin}>Copy PIN</p>
</p>
        </div>
      </div>
    </div>
